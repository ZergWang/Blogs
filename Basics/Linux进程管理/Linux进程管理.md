...
##### 避免死锁
因此，以上四个条件只要令任意一个条件不成立，就能避免死锁。较为简单的方法是通过有序申请资源的方法来破坏循环等待条件。例如，假设进程A和B都要申请资源1和2，则两进程必须按 1 -> 2的顺序申请这两个资源，从而避免进程A占有了资源1，进程B占有资源2，从而陷入死锁的情况。
